...
const NavBar = ({ theme, themeBtnFunc }: NavProps) => {
  return (
    <nav className="fixed top-0 w-full z-[1] bg-whiteT dark:bg-navyT dark:text-white backdrop-blur-sm flex dark:border-b-0 border-b-2 border-hoverGrey border-solid justify-between items-center py-4 px-10">
      {/* logo */}
      ...
      <div className="flex gap-5 items-center">
        {/* links */}
        <div className="flex items-center gap-5 font-raj text-xl">
          <a
            href="#home"
